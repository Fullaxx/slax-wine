...
> [uefi-usb-hdd](https://github.com/Fullaxx/slax-kitchen/blob/b20e07e/docs/20-boot-sequence/uefi-usb-hdd.md).
...
| you want | read |
|---|---|
| every persistence option, session handling, container internals | [persistence-perch](https://github.com/Fullaxx/slax-kitchen/blob/b20e07e/docs/05-using-slax/persistence-perch.md) |
| all three USB routes and what `bootinst` does | [install-to-usb](https://github.com/Fullaxx/slax-kitchen/blob/b20e07e/docs/05-using-slax/install-to-usb.md) |
| disk installs, chainloading, booting an ISO file directly | [install-to-harddisk](https://github.com/Fullaxx/slax-kitchen/blob/b20e07e/docs/05-using-slax/install-to-harddisk.md) |
| boot parameters you can type at the menu | [boot-parameters](https://github.com/Fullaxx/slax-kitchen/blob/b20e07e/docs/20-boot-sequence/boot-parameters.md) |
