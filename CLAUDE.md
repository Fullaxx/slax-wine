...
Read [`docs/UPSTREAM.md`](docs/UPSTREAM.md) § *Local workarounds*, and the stated differences in
every file headed *Adapted from slax-kitchen*. Whatever upstream has since fixed is retired in the
same bump, or kept with the reason written on its row.
